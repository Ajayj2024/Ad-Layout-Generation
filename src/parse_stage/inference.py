...
class Predictor:
    ...
    def __init__(self, predictor_args) -> None:
        ...
        self._setup_model()
        self.text_processor = TextPreprocessor(replace_value=self.args.parser_replace_explicit_value)
    ...
    def _setup_model(self):
        ...
        #     logging.info("Using adapter model")
        #     logging.info(self.args.adapter_config)
